<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        ...
        <h1
            ...
            <span class="inline md:block text-white">Welcome To Foodie Restaurant</span>
        </h1>
        <div class="mx-auto mt-2 text-green-50 md:text-center lg:text-lg">
            <p class="lead">Silahkan Lakukan Reservasi Terlebih Dahulu!</p>
        </div>
    ...
    <section class="px-2 py-32 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        ...
                        <!-- </h1> -->
                        <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl" style="text-align:center;">
                        Boking Meja (Reservasi Ruangan) yaitu pemesanan meja sebelum pelanggan menempati meja makan misalkan untuk 2 atau 3 hari yang akan datang,
                         pemesanan bisa di lakukan dengan telepon atau langsung datang ke restoran tersebut,
                          dengan sistem yang seperti ini memudahkan pelanggan untuk mengadakan acara-acara tertentu misalnya acara perayaan ulang tahun,
                          acara keluarga dll,
                          sehingga pelanggan bisa langsung menempati pada nomor meja yang telah di boking sehingga pelanggan tidak perlu untuk mengantri bila restoran tersebut penuh.
                        </p>
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="{{asset('/img/background1.jpg')}}" style=" border-radius: 37px;"/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">We have 80 years of collective experience with the added benefit of objectivity.<br>
...
We offer a free initial consultation. Contact us today for a free initial consultation!</p>
                        <ul>
                ...
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
                        ...
                        src="{{asset('/img/background2.jpg')}}"
                        alt="feature image" style=" border-radius: 37px;"></div>
            </div>
        </div>
    </section>
